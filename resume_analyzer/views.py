...
from .utils.pdf_analyzer import extract_text_from_pdf, extract_profile_fields
from .utils.ats_analyzer import analyze_with_google_ai, calculate_overall_score
...
def upload_resume(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            overall_score = calculate_overall_score(ats_score, match_percentage, skill_match_score, 
                          experience_match_score, education_match_score, 
                          keyword_density_score, resume_quality_score, bonus_score)
            ...
            profile_info = extract_profile_fields(resume_text)
...
def download_report(request, analysis_id):
    ...
    try:
        ...
        resume_text = extract_text_from_pdf(analysis.resume_file)
